 ...
 *
 * Disassembly of SSDT-4-Ther_Rvp.aml, Wed Mar 25 20:51:24 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000FC1 (4033)
 *     Revision         0x02
 *     Checksum         0x93
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "SSDT", 2, "_ASUS_", "Ther_Rvp", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.PECV, FieldUnitObj)    // (from opcode)
    ...
    Scope (\_TZ)
    {
        ...
        ThermalZone (TZ00)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                {
                    Store (\_SB.PCI0.LPCB.H_EC.ECRD (RefOf (\_SB.PCI0.LPCB.H_EC.PECV)), Local0)
